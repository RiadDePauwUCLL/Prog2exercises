...
# r at the start denotes a raw string. In raw strings, backslashes are treated as literal characters and not as escape characters. 
...
# So, the regular expression r'(.+)\1\1' matches any string that contains a sequence of one or more characters repeated three times in a row. 
